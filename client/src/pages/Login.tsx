...
import { Shield, Lock, User as UserIcon, GraduationCap, ChevronLeft, ArrowRight, Sparkles, Eye, EyeOff, Loader2 } from "lucide-react";
...
export default function LoginPage({ fixedRole }: { fixedRole?: LoginRole }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background selection:bg-indigo-500/30">
      <div className="w-full max-w-xl relative z-10 px-6 space-y-8 py-10 pb-16">
        ...
        {!selectedRole ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in duration-200">
            {Object.entries(roleDetails).map(([id, item]) => (
              <button
                ...
                className="group relative flex flex-col items-center text-center p-5 rounded-[1.5rem] bg-white dark:bg-slate-900 border border-primary/5 dark:border-slate-800 shadow-sm hover:shadow-md hover:border-primary/20 dark:hover:border-primary/30 transition-all duration-200"
              >
                <div className={`p-3 rounded-xl ${item.color} ${item.darkColor} mb-4 group-hover:scale-110 transition-transform duration-200`}>
                ...
                <div className="absolute bottom-4 opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-primary">
          ...
          /* Login Card */
          <div className="max-w-md mx-auto w-full animate-in fade-in duration-200">
            <Card className="bg-white dark:bg-slate-900 border-primary/10 dark:border-slate-800 rounded-[2.5rem] shadow-xl overflow-hidden">
              <CardContent className="p-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full h-14 bg-primary hover:bg-primary/90 text-white font-bold rounded-2xl shadow-lg shadow-primary/20 transition-all duration-200 flex items-center justify-center gap-2"
